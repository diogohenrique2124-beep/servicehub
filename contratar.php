    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-3">
        <label class="form-label">Serviço</label>
         <select name="servicos_ids[]" class="form-select" multiple required size=5>  <!-- o "multiple" é para multipla escolha -->
        ...
        Para selecionar mais de um: seguren <strong>  CTRL</strong>(Windows) ou <strong>CMD</strong> (Mac)
        </small>
      </div>
