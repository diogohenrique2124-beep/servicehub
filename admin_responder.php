...
// verifica se quem está carregado a pagina tem direito ADM
...
<main class="container mt-5">
  <h2>Responder Solicitação #<?=$solicitacao->getId()?></h2>
    ...
    <div class="card shadow p-4 mb-4">
      ...
      <p><strong>Seviços Solicitados</strong></p>
      ...
      <div class="alert alert-secondary"><?= $solicitacao->getDescricaoProblema()?></div>
    </div>
